...
import 'package:street_workout/main.dart';
...
void main() {
  ...
  testWidgets("Create Account Flow", (WidgetTester tester) async {
    await tester.pumpWidget(
      const ProviderScope(
        child: StreetWorkoutApp(),
      ),
    );
    await tester.pumpAndSettle();
    expect(find.byKey(const Key("text_title")), findsOneWidget);
    final login = find.byKey(const Key("text_login"));
