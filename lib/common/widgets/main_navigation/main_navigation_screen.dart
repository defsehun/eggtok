...
import 'package:street_workout/features/inbox/views/inbox_screen.dart';
import 'package:street_workout/features/users/views/user_profile_screen.dart';
      ...
      bottomNavigationBar: Container(
        ...
        child: Padding(
          padding: EdgeInsets.only(
            top: Sizes.size8,
            bottom: MediaQuery.of(context).padding.bottom + Sizes.size8,
          ),
          child: Row(
